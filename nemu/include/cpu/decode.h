...
void load_addr(swaddr_t *, ModR_M *, Operand *);
void read_ModR_M(swaddr_t *, Operand *, bool, Operand *, bool);
...
void general_decode(uint32_t);

#define make_DHelper(name) void concat(decode_, name) (swaddr_t *eip)
typedef void (*DHelper) (swaddr_t *);
