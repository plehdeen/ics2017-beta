...
uint32_t swaddr_read(swaddr_t, int);
uint32_t lnaddr_read(lnaddr_t, int);
uint32_t hwaddr_read(hwaddr_t, int);
void swaddr_write(swaddr_t, int, uint32_t);
void lnaddr_write(lnaddr_t, int, uint32_t);
void hwaddr_write(hwaddr_t, int, uint32_t);
