...
void vga_vmem_io_handler(hwaddr_t addr, int len, bool is_write) {
	if(is_write) {
...
void vga_dac_io_handler(ioaddr_t addr, int len, bool is_write) {
...
void vga_crtc_io_handler(ioaddr_t addr, int len, bool is_write) {
